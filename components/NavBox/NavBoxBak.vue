...
const clickProduct = (id: number, link: string) => {
...
<template>
  <div class="p-5 mt-5">
    ...
    <div class="flex w-full">
      <!-- left -->
      <div class="flex flex-col items-center mt-10 w-9/12">
        <div class="grid grid-auto-rows grid-cols-3 w-full gap-5 c-lg:grid-cols-3 c-md:grid-cols-3 c-sm:grid-cols-2 c-xs:grid-cols-1">
